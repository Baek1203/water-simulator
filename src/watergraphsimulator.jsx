// Lucide 아이콘 사용을 위한 임포트 대용 (CDN 환경 고려)
const { Play, Pause, RotateCcw, Droplet } = typeof Lucide !== 'undefined' ? Lucide : {
  Play: () => <span>▶</span>,
  Pause: () => <span>||</span>,
  RotateCcw: () => <span>↻</span>,
  Droplet: () => <span>💧</span>
...
// 전역 범위에 WaterGraphSimulator 컴포넌트를 등록하여 index.html에서 불러올 수 있도록 합니다.
window.WaterGraphSimulator = function WaterGraphSimulator() {
